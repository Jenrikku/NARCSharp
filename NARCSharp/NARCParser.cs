        ...
        public static NARC Read(byte[] data)
        {
            ...
            if (!data.CheckMagic("BTAF", 16)) // Magic check.
                throw new InvalidDataException(
                    "The FATB section was not found. The file may be corrupted."
                );
            ...
            if (!data.CheckMagic("BTNF", (int)fntbBeginning)) // Magic check.
                throw new InvalidDataException(
                    "The FNTB section was not found. The file may be corrupted."
                );
            ...
            void ReadDirectory(BranchNode<byte[]> dir)
            {
                ...
                while (stream.Peek() != 0)
                { // 0 means that the end of the directory has been reached.
            ...
            if (!data.CheckMagic("GMIF", (int)fimgBeginning)) // Magic check.
                throw new InvalidDataException(
                    "The FIMG section was not found. The file may be corrupted."
                );
